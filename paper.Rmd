...
```{r climateplot, eval=TRUE, echo=FALSE, message=FALSE, htmlcap=figRef("climateplot", "Temperature futures in two alternate realities."), fig.width=5, fig.height=5}
