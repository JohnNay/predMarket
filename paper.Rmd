...
Traders bet on temperature six years in the future. During the six-year period, traders buy and sell futures. Every year, there is Bayesian updating of traders personal predictions for future temperature based on the current year's temperature. At the end of each six-year period, winners collect money and traders revise beliefs about climate models, based on ideology and beliefs of top earners in their social network. In this section, we describe the models used to generate future temperature data, agents beliefs about those models, the market, and the social network connecting agents. We conclude with details on model dynamics and an overview of the model parameters.
