...
Our sensitivity analysis, `r figRef("sa")`, shows that

```{r sa, eval=TRUE, echo=FALSE, message=FALSE, htmlcap=figRef("sa", "Sensitivty analysis"), fig.width=5, fig.height=5}
library(eat)
load("output/src_future.Rda")
plot(src_future, outcome_var = "Convergence") + theme_classic() 
