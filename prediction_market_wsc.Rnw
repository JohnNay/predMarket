...
library(knitr)
opts_chunk$set(fig.align = "center", cache = FALSE)
@
...
We conclude with details on model dynamics and an overview of the model parameters we experimentally vary. The model code and a full \href{https://github.com/JohnNay/predMarket/blob/master/odd.pdf}{Overview, Design concepts and Details (ODD) specification} can be found on \href{https://github.com/JohnNay/predMarket}{the project website}.
