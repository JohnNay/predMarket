...
\noindent {\bf MARTIN VAN DER LINDEN} is a Ph.D. Candidate at Vanderbilt University. He studies the design and performances of market and institutions using tools from economic theory and game theory.
