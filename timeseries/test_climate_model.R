...
mdl.co2 <- init_model(mdl.co2, n_burn_in = 100, n_future = 100, covars = list('log.co2'), future_covars = future_co2)
...
mdl.tsi <- init_model(mdl.tsi, n_burn_in = 100, n_future = 100, covars = list('tsi'), future_covars = future_tsi)
